...
const Videos = () => {
  ...
  return (
    ...
    <Stack direction={['column','row']} h={'100vh'}  >
      <VStack w={'full'} >
          <video controls controlsList='nodownloads' src={videoSrc} style={{width :"100%"}}>
            
            </video>    
            <VStack alignItems={'flex-start'} w={'full'} p={'8'} overflowY={'auto'} margin={'2rem'}>
                <Heading>
                    Video 1
                </Heading>
                <Text>
      ...
      >
        <Heading alignSelf={'center'} >Lectures</Heading>
